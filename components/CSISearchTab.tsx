          ...
          return (
            <div key={index} className="flex items-center gap-1">
              <div className="flex items-center gap-1.5 bg-gray-50 rounded px-2 py-1 border border-gray-200">
                <span
                  className={`px-1.5 py-0.5 text-[10px] font-bold rounded border ${levelColor}`}
                >
                  L{level}
                </span>
    ...
    <div className="p-4 space-y-4">
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm font-medium text-gray-700">Fuzzy Search</span>
            <div className="relative group">
              ...
              <div className="absolute right-0 top-6 w-64 bg-gray-900 text-white text-xs rounded-lg p-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10 pointer-events-none">
                <div className="relative">
                  <div className="absolute -top-3 right-2 w-2 h-2 bg-gray-900 transform rotate-45"></div>
                  {fuzzySearch
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                fuzzySearch ? 'bg-blue-600' : 'bg-gray-300'
              }`}
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-2 pr-10 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 placeholder-gray-400"
          />
          {query && !isSearching && (
            <button
              onClick={() => {
        ...
        <div className="space-y-2">
              ...
              <div className="space-y-2 max-h-[calc(100vh-400px)] overflow-y-auto">
                {results.map((result) => (
                  <button
                    ...
                    className="w-full text-left p-3 bg-white border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:shadow-md transition-all group"
                  >
                    <div className="space-y-2">
              ...
              <div className="space-y-2 max-h-[calc(100vh-450px)] overflow-y-auto">
                {aiMatches.map((match, index) => (
                  <button
                    ...
                    className="w-full text-left p-4 bg-white border-2 border-purple-200 rounded-lg hover:border-purple-500 hover:shadow-lg transition-all group"
                  >
                      ...
                      <div className="flex-1 min-w-0 space-y-2">
                        <div>
                          <div className="flex items-center gap-2 mb-2">
                            <span className="font-mono text-sm font-bold text-purple-600 group-hover:text-purple-700">
                              {match.code}
                            </span>
                          ...
                          <p className="text-sm font-medium text-gray-900 group-hover:text-purple-900 mb-2">
                            {match.title}
                          </p>
                        </div>
                        <div className="bg-purple-50 rounded p-2">
                          <p className="text-xs text-gray-700">
                            <span className="font-semibold">Why this?</span> {match.reasoning}
                          </p>
                        </div>
          ...
          {results.length === 0 && aiMatches.length === 0 && !isAIMatching && !aiError && (
            <div className="text-center py-8">
              ...
              <h3 className="mt-3 text-sm font-medium text-gray-900">No results found</h3>
      ...
      {query.length < 2 && results.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="mt-4 text-sm font-medium text-gray-900">Search CSI Codes</h3>
