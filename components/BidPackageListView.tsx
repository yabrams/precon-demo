      ...
      <div className="p-6">
        <div className="max-w-5xl mx-auto">
            ...
            <div className="mb-8 bg-white rounded-lg shadow-sm border border-gray-200 p-5">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-md font-semibold text-gray-900">
                  Project Diagrams ({project.diagrams.length})
                </h3>
                {onUploadDiagrams && (
                  <>
                    <input
                    ...
                    <label
                      ...
                      className="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-md hover:bg-blue-700 transition-colors flex items-center cursor-pointer"
                    >
                      <svg
          ...
          {(!project.diagrams || project.diagrams.length === 0) && onUploadDiagrams && (
            <div className="mb-8 bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
          ...
          {bidPackages.length === 0 ? (
            <div className="bg-white rounded-lg shadow-sm p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No Bid Packages</h3>
              <p className="text-gray-500">This project doesn't have any bid packages yet</p>
            </div>
          ) : (
                      ...
                      {bidPackage.bidDueDate && (
                        <div className="flex items-center">
                          ...
                          <span className="text-sm text-gray-600">
                            Due: {formatDate(bidPackage.bidDueDate)}
                          </span>
                        </div>
                      )}
